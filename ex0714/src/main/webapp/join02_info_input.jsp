...
<html>
	...
	<body>
		...
		<section>
			<form name="agree" method="get" action="./JoinOk2">
				...
				<fieldset class="fieldset_class">
					...
					<dl id="join_newsletter_dl">
						...
						<dd>
							...
							<div>
								<input type="radio" name="newletter" id="newletter_y" value="y" checked="checked"/>
								<label for="newletter_y">예</label>
								<input type="radio" name="newletter" id="newletter_n" value="n" />
					...
					<dl id="join_sms_dl">
						...
						<dd>
							<span>이메일을 통한 상품 및 이벤트 정보 수신에 동의합니다.</span>
							<div>
								<input type="radio" name="sms" id="sms_y" value="y" checked="checked"/>
								<label for="sms_y">예</label>
								<input type="radio" name="sms" id="sms_n" value="n" />
				...
				<fieldset class="fieldset_class">
					...
					<dl id="join_marital_status_dl">
						...
						<dd>
							<input type="radio" name="marital_status" id="marital_status_y" value="y" />
							<label for="marital_status_y">예</label>
							<input type="radio" name="marital_status" id="marital_status_n" value="n" />
